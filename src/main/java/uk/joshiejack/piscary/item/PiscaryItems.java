...
import uk.joshiejack.penguinlib.item.base.PenguinFishingRodItem;
...
public class PiscaryItems {
    ...
    public static final RegistryObject<Item> FISHING_ROD = ITEMS.register("fishing_rod", () -> new PenguinFishingRodItem(new Item.Properties().durability(128).tab(Piscary.TAB), 3));
