...
public class SiameseFightingFishModel extends AbstractFishModel {
    public SiameseFightingFishModel() {
        ...
        tail.texOffs(0, 0).addBox(-1.0F, -1.0F, 4.0F, 2.0F, 2.0F, 3.0F, 0.0F, false);
        tail.texOffs(0, 0).addBox(0.0F, -3.4F, 3.0F, 0.0F, 7.0F, 7.0F, 0.0F, false);

        body = new ModelRenderer(this);
        body.setPos(0.0F, 24.0F, 0.0F);
        body.texOffs(7, 2).addBox(-1.0F, -2.0F, 4.0F, 2.0F, 2.0F, 3.0F, 0.0F, false);
        body.texOffs(0, 5).addBox(-1.0F, -1.6F, 3.0F, 2.0F, 1.0F, 1.0F, 0.0F, false);
        ...
        fin_right_r1.texOffs(4, 12).addBox(0.0F, -0.5F, 0.0F, 0.0F, 1.0F, 2.0F, 0.0F, false);
        ...
        fin_left_r1.texOffs(0, 12).addBox(0.0F, -0.5F, 0.0F, 0.0F, 1.0F, 2.0F, 0.0F, false);
    }
}
