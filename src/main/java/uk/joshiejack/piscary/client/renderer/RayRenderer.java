...
@OnlyIn(Dist.CLIENT)
public class RayRenderer extends MobRenderer<AbstractFishEntity, EntityModel<AbstractFishEntity>> {
    private final ResourceLocation texture;

    public RayRenderer(EntityRendererManager manager, EntityModel<AbstractFishEntity> model, String entity) {
